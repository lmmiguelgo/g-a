      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto flex max-w-2xl flex-col items-end justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row">
          ...
          <div className="w-full lg:max-w-xl lg:flex-auto">
              ...
              {jobOpenings.map((opening) => (
                <li key={opening.id} className="py-8">
                  <dl className="relative flex flex-wrap gap-x-3">
                    ...
                    <dd className="mt-2 w-full flex-none text-base/7 text-accent-secondary">{opening.description}</dd>
                    <dt className="sr-only">Salary</dt>
                    <dd className="mt-4 text-base/7 font-semibold text-foreground">{opening.salary}</dd>
            ...
            <div className="mt-8 flex border-t border-accent-secondary/20 pt-8">
              <a href="#" className="text-sm/6 font-semibold text-accent-primary hover:text-accent-primary/80">
