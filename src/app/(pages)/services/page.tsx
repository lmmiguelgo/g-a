...
const ServicesPage
 = () => {
  return (
     <section id="services-section" className="overflow-x-hidden w-full  h-screen lg:h-fit scale-96 lg:scale-100  ">
            <div className="bg-background py-24 sm:py-32">
                <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-6 lg:mt-8 lg:grid-cols-6 lg:grid-rows-2">
                        ...
                        <Link href="/services/business-management" id="home-service1" className="group relative lg:col-span-3 ">
                        ...
                        <Link href="/services/tax-services" id="home-service2" className="group relative lg:col-span-3 ">
                        ...
                        <Link href="/services/executive-mentorship" id="home-service3" className="group relative lg:col-span-2 ">
                        ...
                        <Link href="/services/small-business-consulting" id="home-service4" className="group relative lg:col-span-2  ">
                        ...
                        <Link href="/services/above-the-neck" id="home-service5" className="group relative lg:col-span-2  ">
