...
export default function PhilanthropyPage() {
  ...
  return (
    <>
      ...
      <section id="philanthropy-page" className=" bg-background w-screen py-24 lg:py-32 overflow-hidden ">
      ...
      <div id="cta-gammys" className="  flex flex-col items-center justify-center  ">
        <div id="cta-gammys-container" className="mx-auto max-w-7xl w-full py-24 sm:px-6 sm:py-32 lg:px-8 p-4">
          <div className="relative isolate overflow-hidden bg-second-bg h-100 rounded-2xl lg:h-auto px-6 pt-16 after:pointer-events-none after:absolute after:inset-0 after:inset-ring after:inset-ring-white/10 sm:rounded-3xl sm:px-16 after:sm:rounded-3xl md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            <svg
            ...
            <div className="relative mt-16 h-80 lg:mt-0">
              <Image
                ...
                width={1824}
                height={1080}
                className="absolute top-20 left-10 w-70 max-w-none rounded-md hidden lg:block"
              />
            </div>
          </div>
        </div>
      ...
      <div id="cta-eden-global" className=" flex flex-col items-center justify-center ">
        <div className="mx-auto max-w-7xl w-full  sm:px-6 sm:py-32 lg:px-8 p-4">
          <div className="relative isolate overflow-hidden bg-second-bg px-6 h-100 rounded-2xl lg:h-auto pt-16 after:pointer-events-none after:absolute after:inset-0 after:inset-ring after:inset-ring-white/10 sm:rounded-3xl sm:px-16 after:sm:rounded-3xl md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            <svg
              viewBox="0 0 1024 1024"
              aria-hidden="true"
