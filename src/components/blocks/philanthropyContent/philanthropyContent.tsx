      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <section className="mt-8 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-8">
          <div className="lg:pr-8">
            <h2 className="text-2xl font-semibold tracking-tight text-pretty text-foreground">Gammy’s House</h2>
          ...
          <div className="pt-16 lg:row-span-2 lg:-mr-16 xl:mr-auto">
            <div className="-mx-8 grid grid-cols-2 gap-4 sm:-mx-16 sm:grid-cols-4 lg:mx-0 lg:grid-cols-2 xl:gap-8">
              <div className="aspect-square overflow-hidden rounded-xl outline-1 -outline-offset-1 outline-foreground/10">
                <Image
                  alt=""
                  src={Pic.USExample}
              ...
              <div className="-mt-8 aspect-square overflow-hidden rounded-xl outline-1 -outline-offset-1 outline-foreground/10 lg:-mt-40">
                <Image
                  alt=""
          ...
          <div className="max-lg:mt-16 lg:col-span-1">
            ...
            <dl className="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
              <div className="flex flex-col gap-y-2 border-b border-dotted border-second-bg pb-4">
                ...
                <Image className="rounded-lg border-4 border-foreground/20" src={Pic.ZambiaFlag} alt="Zambia Flag" />
              </div>
              <div className="flex flex-col gap-y-2 border-b border-dotted border-second-bg pb-4">
                <dt className="text-md/6 text-accent-secondary">Building schools in <strong>Kenya.</strong></dt>
                <Image className="rounded-lg border-4 border-foreground/20" src={Pic.KenyaFlag} alt="Kenya Flag" />
              </div>
              <div className="flex flex-col gap-y-2 max-sm:border-b max-sm:border-dotted max-sm:border-second-bg max-sm:pb-4">
                ...
                <Image className="rounded-lg border-4 border-foreground/20" src={Pic.UnitedStatesFlag} alt="United States Flag" />
              </div>
              <div className="flex flex-col gap-y-2">
                <dt className="text-md/6 text-accent-secondary">Conducting workshops empowering business owners in <strong>Uganda.</strong></dt>
                <Image className="rounded-lg border-4 border-foreground/20" src={Pic.UgandaFlag} alt="Uganda Flag" />
              </div>
            </dl>
          </div>
        </section>
