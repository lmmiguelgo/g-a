...
const HomeNavigation = () => {
  ...
  const scrollPositions = [0, 2400, 6200, 8800, 12580, 13800, 17000, 21800, 24800, 28000, 31200];
  ...
  return (
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-40 flex items-center gap-6 bg-black/40 backdrop-blur-md px-6 py-3 rounded-full border border-white/10 shadow-2xl transition-all duration-300 hover:bg-black/50">
        <button 
            onClick={() => {
              steps[0]();
              setCurrentStep(0);
